...
public class AudioHandler extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        // AudioRecord Library
        // ==========================================================================
        else if (action.equals("startAudioRecording")) {
            recordId = args.getString(0);
            String target = args.getString(1);
            try {
                Uri targetUri = resourceApi.remapUri(Uri.parse(target));
            ...
            promptForRecord(true);
        } else if (action.equals("stopAudioRecording")) {
            this.stopRecordingAudio(args.getString(0), true);
        }
        // ==========================================================================
     ...
     * @param file The name of the file
     */
    public void startAudioRecording(String id, String file) {
        AudioPlayer audio = getOrCreatePlayer(id, file);
        audio.startAudioRecording(file);
    }
     ...
     * @param stop If true stop recording, if false pause recording
     */
    public void stopAudioRecording(String id) {
        AudioPlayer audio = this.players.get(id);
        if (audio != null) {
    ...
    private void promptForRecord(boolean isAudioRecord) {
        if (PermissionHelper.hasPermission(this, permissions[WRITE_EXTERNAL_STORAGE])
            ...
            this.startRecordingAudio(recordId, FileHelper.stripFileProtocol(fileUriStr));
                ...
                && PermissionHelper.hasPermission(this, permissions[RECORD_AUDIO]) && isAudioRecord) {
            this.startAudioRecording(recordId, FileHelper.stripFileProtocol(fileUriStr));
